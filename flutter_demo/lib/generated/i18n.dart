...
class I18n implements WidgetsLocalizations {
  ...
  /// "Hello ${name}!"
  String helloTo(String name) => "Hello ${name}!";
...
class _I18n_zh_CN extends I18n {
  ...
  /// "你好 ${name}!"
  @override
  String helloTo(String name) => "你好 ${name}!";

  /// "很高兴见到你, ${name}!"
  @override
  String greetTo(String name) => "很高兴见到你, ${name}!";
...
class GeneratedLocalizationsDelegate
  ...
  List<Locale> get supportedLocales {
    return const <Locale>[const Locale("en", "US"), const Locale("zh", "CN")];
  }
